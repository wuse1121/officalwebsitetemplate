...
function setpraise(aid,hrefname,obj){$.get(hrefname,{'aid':aid},function(data,status){if(data!=''){data=JSON.parse(data);if(data[0]=='1'){alert("点赞成功！");$(obj).val('取消赞');}else{alert("取消点赞！");$(obj).val('点赞');}
